...
//   import { useSearch } from './SearchContext'; // SearchContext 파일의 경로
    ...
    return (
      <InputGroup {...rest}>
        <Input
          ...
          // onKeyPress={handleKeyPress} // 엔터 키 입력 시 검색어 업데이트
        ...
        <InputRightElement
          children={
            <IconButton
              ...
              icon={<MagnifyingGlassIcon className="h-15 w-15 text-gray-500" />} //color={searchIconColor} w="15px" h="15px"
